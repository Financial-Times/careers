...
**Data Engineering**\
The Data engingineering team work closely with the Data Science and Analytics teams to provide APIs and other capabilities that enable the rest of FT engineering to use these data insights in a streamlined way
...
This team looks after the technical ecosystem that supports our Marketing teams, including our email platform serves the roughly 8 million emails that are sent every week to our customers who subscribe to our content. 
...
**CRM Technology**\
Our CRM Team look after our Salesforce platform and the different applications used by our Sales teams.
...
- ~10% performance-based bonus given out every Feb. (We're skipping 2021 for all staff due to the current situation, but back from 2022)
